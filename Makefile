...
install:
	...
	install -Dm755 jetbrains-search-provider.py $(LIBDIR)/gnome-search-providers-jetbrains/
	install -Dm644 de.swsnr.searchprovider.Jetbrains.service $(LIBDIR)/systemd/user/
